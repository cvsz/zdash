...
export type GoogleFinanceSection = {
  id: string;
  url: string;
};

export type GoogleFinanceInstrument = {
  symbol: string;
  name: string;
  asset_class: string;
  region: string;
...
export type GoogleFinanceOverview = {
  provider: string;
  mode: string;
  scraping_enabled: boolean;
  base_url: string;
  sections: GoogleFinanceSection[];
  watchlist: GoogleFinanceInstrument[];
  warnings: string[];
  timestamp: string;
};

const fallbackOverview: GoogleFinanceOverview = {
...
export const getGoogleFinanceOverview = () =>
  apiClient.get<GoogleFinanceOverview>("/api/integrations/google-finance/overview", fallbackOverview);

export const getGoogleFinanceSearch = (query: string) =>
